  ...
  // 4. Create the trace object for the gauge chart.
    var gaugeData = [{
      ...
      gauge: {
        ...
        bar: {color: "black"},
        steps:[
          { range: [0, 1], color: "#FCFFF9" },
          { range: [1, 2], color: "#F5FFED" },
          { range: [2, 3], color: "#EFFFE1" },
          { range: [3, 4], color: "#E9FFD5" },
          { range: [4, 5], color: "#E5FFCF" },
          { range: [5, 6], color: "#E2FFC9" },
          { range: [6, 7], color: "#DFFFC3" },
          { range: [7, 8], color: "#C9E6B0" },
          { range: [8, 9], color: "#81FF0B" },
          { range: [9, 10], color: "#274D03" },
        ]
      }
    }];
